        ...
        <div class="card">
            <div class="card-body">
                <form class="mt-4" action="<?= base_url('kerusakan/insert') ?>" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="kerusakan" id="kerusakan" required oninvalid="this.setCustomValidity('Gejala tidak boleh kosong')" oninput="setCustomValidity('')">
                    </div>
